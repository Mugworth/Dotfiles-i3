 ...
 */
//static char *font = "FantasqueSansMono Nerd "
 //                   "Font:Medium:pixelsize=14:antialias=true:autohint=true";
//static char *font = "agave Nerd Font Mono:fontsizel=26:antialias=true:autohint=true";
static char *font = "CozetteVector:pixelsize=16:antialias=true:autohint=true";
static char *font2[] = {
    "CozetteVector:fontsizel=14:antialias=true:autohint=true",
    "CozetteVector:fontsizel=14:antialias=true:autohint=true",
    "CozetteVector:fontsizel=14:antialias=true:autohint=true"};
...
static char *copyurlcmd[] = {"/bin/sh", "-c", "st-urlhandler -c",
                             "externalpipe", NULL};
/* static char *lfcd[] = {"/bin/zsh", "-c", "lfcd", */
/*                              NULL}; */
...
static Shortcut shortcuts[] = {
  ...
  // {MODKEY, XK_a, changealpha, {.f = +0.05}},
   ...
   // {TERMMOD, XK_D, zoom, {.f = -2}},
    ...
    /* {MODKEY, XK_l, externalpipe, {.v = lfcd}}, */
};
